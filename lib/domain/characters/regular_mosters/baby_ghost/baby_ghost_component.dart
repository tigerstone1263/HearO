...
import 'package:hear_o/domain/characters/regular_mosters/reg_monster_component.dart';

enum MonsterState { calm, enraged }

class RegMonsterBabyGhost extends CircleComponent
    with CollisionCallbacks
    implements RegMonsterComponent {
  RegMonsterBabyGhost({
